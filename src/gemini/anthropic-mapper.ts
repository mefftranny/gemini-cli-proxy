...
export const mapAnthropicMessagesRequestToGemini = (
    ...
    if (request.tool_choice) {
        geminiRequest.toolConfig = mapAnthropicToolChoiceToGemini(
            request.tool_choice
        );
    }
...
const mapAnthropicMessagesToGeminiFormat = (
...
const mapAnthropicMessageToGeminiFormat = (
...
const convertAnthropicToolToGemini = (
    tool: Anthropic.Tool
...
const mapAnthropicToolChoiceToGemini = (
...
export const mapGeminiResponseToAnthropic = (
    ...
    return {
        ...
        model,
        stop_reason:
            (geminiResponse.tool_calls?.length ?? 0) > 0
                ? "tool_use"
                : "end_turn",
        usage: {
